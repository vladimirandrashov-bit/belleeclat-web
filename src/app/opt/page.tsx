...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: "BelleEclat принципиально не продаётся на Ozon, WB и Яндекс Маркете. Ни один другой партнёр не обрушит вам цену через интернет.",
  },
  {
    icon: "◆",
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "60px 24px" }}>
          ...
          <div style={{
            ...
            {[
              { tier: "от 30 штук",  price: "1 500 ₽/шт", profit: "прибыль 2 000 ₽" },
              { tier: "от 100 штук", price: "1 200 ₽/шт", profit: "прибыль 2 300 ₽" },
              { tier: "Розница",     price: "3 500 ₽",     profit: "РРЦ по договору" },
          ...
          <p style={{
            ...
            Микс ароматов разрешён · 100% предоплата · Отгрузка 3 рабочих дня · Доставка СДЭК/ПЭК
          </p>
        </div>
      </section>
